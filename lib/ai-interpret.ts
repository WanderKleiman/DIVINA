  ...
  "sections": [
    {
      ...
      "story": "(2500-3500 символов) Как ты и этот человек воспринимают друг друга с первых минут. Что в нём притягивает тебя как тип личности, что в тебе притягивает его. Как ваши энергии считывают друг друга — что совпадает мгновенно, а что требует времени. Что вас удивляет, что вызывает интерес, что настораживает. Конкретный психологический анализ двух архетипов при встрече."
    },
    {
      "title": "Любовь и нежность",
      "story": "(2500-3500 символов) Как ты выражаешь любовь и как партнёр воспринимает её исходя из ваших природ. Как партнёр выражает заботу и соответствует ли это тому, что тебе нужно. Где ваши языки любви совпадают, где расходятся и как это проявляется в реальных ситуациях. Что нужно каждому из вас чтобы чувствовать себя любимым. Как ваши эмоциональные архетипы взаимодействуют в близости."
    },
    {
      "title": "Эмоции и чувства",
      "story": "(2500-3500 символов) Как каждый из вас устроен эмоционально по своей природе. Как ты реагируешь на стресс, конфликт, радость — и как реагирует партнёр. Где ваши эмоциональные реакции резонируют, а где создают непонимание. Как вы поддерживаете друг друга в трудные моменты. Что происходит когда один из вас закрывается — как другой это воспринимает. Глубокий разбор эмоциональной динамики этой пары."
    },
    {
      "title": "Ценности и жизненные цели",
      "story": "(2500-3500 символов) Что для тебя фундаментально важно в жизни исходя из твоей карты, и что важно для партнёра. Как вы смотрите на семью, свободу, деньги, карьеру, развитие. Где ваши приоритеты совпадают и создают прочную основу. Где расходятся и как это может проявиться через несколько лет отношений. Что нужно обсуждать заранее чтобы эти расхождения не стали источником разочарования."
    },
    {
      "title": "Страсть и притяжение",
      "story": "(2500-3500 символов) Насколько сильно физическое и чувственное притяжение между вашими типами. Что его питает — какие качества друг друга вы находите притягательными. Как взаимодействуют ваши природные энергии притяжения и желания. Что поддерживает огонь в долгосрочных отношениях для людей с вашими картами. Что может его гасить и как этого не допустить. Как ваша страсть трансформируется со временем."
    },
    {
      "title": "Конфликты и разногласия",
      "story": "(2500-3500 символов) Типичные зоны напряжения между вашими типами — где и почему именно вы расходитесь. Как ты ведёшь себя в конфликте по своей природе, как ведёт себя партнёр. Что больше всего задевает каждого из вас. Как вы миритесь — и что мешает. Какие паттерны ссор характерны для этого сочетания знаков. Что нужно изменить в подходе чтобы конфликты становились точками роста."
    },
    {
      "title": "Общий рост и потенциал",
      "story": "(2500-3500 символов) Что ты получаешь от этого человека для своего развития — чему он тебя учит, какие твои стороны он раскрывает. Что партнёр получает от тебя. Какой урок несёт для тебя это сочетание. К чему может прийти эта пара если оба будут работать над собой. Что делает этот союз особенным и редким. Долгосрочный потенциал ваших отношений."
    }
  ],
