...
const dict: Record<string, Record<Locale, string>> = {
  ...
  "paywall.sub.perk1": { ru: "Детальный недельный прогноз каждую неделю", en: "Detailed weekly forecast every week" },
  "paywall.sub.perk2": { ru: "3 проверки совместимости в месяц", en: "3 compatibility checks per month" },
  "paywall.sub.perk3": { ru: "Расширенные транзиты и аспекты", en: "Extended transits and aspects" },
  "paywall.sub.perk4": { ru: "Без рекламы", en: "No ads" },
