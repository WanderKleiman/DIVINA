...
const dict: Record<string, Record<Locale, string>> = {
  ...
  "paywall.sub.headline": { ru: "Знай свой ритм.", en: "Know your rhythm." },
  "paywall.sub.desc": { ru: "Divina делает ритм жизни предсказуемым — каждый день, неделю и месяц ты всегда знаешь, что впереди.", en: "Divina makes your life rhythm predictable — every day, week and month you always know what's ahead." },
  ...
  "paywall.trialCta": { ru: "Начать бесплатно — 7 дней", en: "Start free — 7 days" },
