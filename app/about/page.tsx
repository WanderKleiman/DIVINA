      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            padding: 0, textDecoration: "underline", textDecorationColor: "rgba(255,255,255,0.15)",
            fontFamily: "inherit",
          }}
        >
          Публичная оферта
        ...
        >
          ...
          >
            ...
            <div style={{
              ...
              <div>
                <p style={{ fontSize: 17, fontWeight: 700, margin: 0 }}>Публичная оферта</p>
            ...
            <div style={{ overflowY: "auto", padding: "20px 24px 40px", flex: 1 }}>
              {OFERTA_SECTIONS.map((section, si) => (
                <div key={si} style={{ marginBottom: 24 }}>
                  <p style={{ fontSize: 13, fontWeight: 700, color: "rgba(255,255,255,0.7)", margin: "0 0 10px", letterSpacing: "0.01em" }}>
                    {section.title}
                  </p>
                  {section.items.map((text, ti) => (
                    <p key={ti} style={{ fontSize: 13, color: "rgba(255,255,255,0.5)", lineHeight: 1.7, margin: "0 0 8px" }}>
                      {text}
                    </p>
                  ))}
                </div>
