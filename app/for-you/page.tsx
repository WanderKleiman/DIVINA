...
const oneTimePurchases = [
  {
    ...
    description: "Полный разбор карты рождения с интерпретацией",
  },
  {
    id: "weekly" as const,
    ...
    title: "Расклад на 1 неделю",
    description: "Детальный прогноз на каждый день недели",
  },
  {
    ...
    title: "Совместимость",
    description: "Совместимость с партнёром по натальным картам",
  },
];
...
const PURCHASE_LABELS: Record<string, string> = {
  interpretation: "Расшифровка натальной карты",
      ...
      <div className="stagger flex flex-col gap-7">
          ...
          >
            ...
            <div className="relative z-10 p-5">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h2 className="text-lg font-bold text-white">Divina Pro</h2>
                  <p className="text-[11px] text-white/40 tracking-wider">ПОДПИСКА</p>
                </div>
              </div>
              <p className="text-sm text-white/70 mb-4">
                Недельные прогнозы, совместимость и расширенные транзиты — всё в одной подписке
              </p>
              <div className="flex items-center justify-between">
                <span className="text-xs text-white/40" suppressHydrationWarning>от {prices.yearWeekly}/неделя</span>
        ...
        {purchases.length > 0 && (
          <div className="animate-fade-in-up px-5 pt-2 pb-4">
            <h3 className="text-xs font-medium text-white/70 tracking-wider uppercase mb-3">Мои покупки</h3>
