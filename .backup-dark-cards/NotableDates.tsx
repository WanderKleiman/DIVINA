          ...
          >
            <div className="relative z-10 p-4">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-xs font-medium text-white/40 bg-white/5 rounded-lg px-2 py-0.5 border border-white/10">
                  {formatDateLocalized(nd.date, lang)}
                </span>
                <span className="text-sm font-medium text-white/80 truncate">{nd.label}</span>
              </div>
              <p className="text-sm text-white/60 mb-2">{nd.brief}</p>
              <div className="flex items-center justify-between border-t border-white/10 pt-2">
                <p className="text-xs text-white/50 italic flex-1">
                  {nd.recommendation}
                </p>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="text-white/30 shrink-0 ml-2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
