    ...
    <div className="glass w-full text-left">
      <div className="relative z-10 p-4">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-black/[0.05] border border-black/[0.07]">
          ...
          <div className="flex-1 min-w-0">
                ...
                {Array.from({ length: 5 }).map((_, i) => (
                  <div
                    ...
                    className={`h-1.5 w-1.5 rounded-full ${
                      i < forecast.rating ? "bg-black/70" : "bg-black/10"
                    }`}
                  />
                ))}
              </div>
            ...
            {forecast.detailed && (
              <p className="mt-1.5 text-xs leading-relaxed text-black/35">
                {forecast.detailed}
              </p>
            )}
          </div>
